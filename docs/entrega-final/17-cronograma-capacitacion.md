...
```mermaid
gantt
    title Cronograma de capacitacion y puesta en marcha
    dateFormat YYYY-MM-DD
    axisFormat %d/%m

    section Preparacion
    Elaboracion de manuales y guias      :done, p1, 2026-12-01, 7d
    Aprovisionamiento entorno practica   :done, p2, 2026-12-07, 3d

    section Capacitacion interna
    S1 Fundamentos y navegacion          :done, c1, 2026-12-10, 1d
    S2 Consorcios unidades y personas    :done, c2, 2026-12-10, 1d
    S3 Gastos y comprobantes asistidos   :done, c3, 2026-12-11, 1d
    S4 Liquidacion prorrateo y emision   :done, crit, c4, 2026-12-14, 2d
    S5 Cobranzas pagos y morosidad       :done, c5, 2026-12-16, 1d
    S6 Reclamos reservas y comunicacion  :done, c6, 2026-12-17, 1d
    S7 Indicadores y toma de decisiones  :done, c7, 2026-12-18, 1d

    section Acompanamiento real
    Primera liquidacion asistida (Enero) :done, crit, a1, 2027-01-04, 5d
    Segunda liquidacion supervisada (Feb):done, a2, 2027-02-01, 5d

    section Consorcistas
    Distribucion de la guia rapida       :done, d1, 2026-12-21, 10d
    Charlas en asambleas ordinarias      :done, d2, 2027-01-11, 25d
```
