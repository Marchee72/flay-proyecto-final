...
| ID | Caso | Resultado esperado | Estado |
|---|---|---|---|
| PI-01 | Extracción sobre 30 comprobantes de formatos variados (ficticios, generados; ver § 14.3) | Al menos 80 % de campos correctos, según el criterio del punto 8.4.3 | **Supera**: 149 de 150 campos (99,3 %), 11/09/2026, `datos-cliente/poc-resultados/extraccion-gemini-consolidado.json` |
...
| PI-06 | Consulta documental con 20 preguntas frecuentes sobre un reglamento de 72 artículos (ficticio) | Al menos 85 % con el fragmento correcto entre los tres primeros | **Supera**: 20 de 20 (100 %), 19 en primer lugar; línea de base léxica 16 de 20. 11/09/2026, `datos-cliente/poc-resultados/busqueda-gemini.json` |
