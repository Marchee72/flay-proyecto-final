...
- [X] T086 Registrar las tres condiciones de § 5.5.4 como verificadas en `docs/entrega-final/15-pruebas.md`: degradación ante terceros (SC-013 y SC-008), exportación abierta (SC-018), PoC de `RF-20` (US1) (`FR-033`)
- [X] T087 [P] Completar `docs/entrega-final/15-pruebas.md` con el resultado real de `PA-01` a `PA-07`, `PI-01` a `PI-09`, `PR-01` a `PR-09` y `PN-01` a `PN-06`, nombrando la prueba automática o el guion que lo verifica (`FR-034`)
- [X] T088 [P] Actualizar `docs/entrega-final/13-prototipo.md` § 13.3 (estado por módulo al cierre), § 13.5 (accesos) y § 13.7 (limitaciones: depósitos, baja de documentos, HEIC/TIFF, sólo PDF indexable), y § 13.4 con el hash de la semilla (SC-019, `FR-035`)
- [X] T089 [P] Actualizar `docs/entrega-final/14-codificacion.md` § 14.5 con el esfuerzo real contra las 243 h y § 14.3 «Verificación de la reemplazabilidad» apuntando a `src/infraestructura/asistencia/` y a la prueba de SC-012
- [X] T090 [P] Escribir `docs/entrega-final/16-manual-usuario.md` por rol (administrador, consejo, consorcista) sobre las pantallas reales, con capturas del entorno de demostración y la semilla ficticia
